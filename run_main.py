...
with open("error_log.txt", "a") as error_log:
    ...
    for i in range(len(unique_ids)):
        ...
        try:
            result = subprocess.run(["python", "main.py", "--archi_num", str(archi_num), "--csv_file", args.csv_file, "--image_dataset", args.image_dataset,"--post_temp",args.post_temp], stderr=subprocess.PIPE, text=True)
            ...
            error_msg = f"Subprocess error for archi_num: {archi_num}, csv_file, {args.csv_file}, image_dataset, {args.image_dataset},post_temp,{args.post_temp}. Error: {e}\n"
            print(error_msg)
