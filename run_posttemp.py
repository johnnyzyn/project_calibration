...
with open("error_log.txt", "a") as error_log:
    ...
    for i in range(len(unique_ids)):
        ...
        try:
            ...
            error_log.write(error_msg)
            continue
# python run_posttemp.py --csv_file cifar10_post.csv --image_dataset cifar10 --post_temp True --device cuda:3
# python run_posttemp.py --csv_file cifar100_post.csv --image_dataset cifar100 --post_temp True --device cuda:3
# python run_posttemp.py --csv_file imagenet_post.csv --image_dataset ImageNet16-120 --post_temp True --device cuda:3
